...
class Approximator_NN_ND_Cum(ApproximatorND):
    ...
    def update_name(self):
        ...
        self.name = f"NN_{layer_str}_E{self.epochSum}_N{self.samplePoints}"
    ...
    def train(self, function):
        ...
        # Nur initialisieren, wenn noch kein Netzwerk vorhanden ist
        ...
        # Weitertrainieren auf dem bestehenden Modell
