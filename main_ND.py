...
def getApprox():
    approx_nn_nd = Approximator_NN_ND("Versuch NN 64-64-64-64 & 7k Epochen & 400^n Punkten",[2000,1000,[4,4,4]])
    approx_nn_nd2 = Approximator_NN_ND("Versuch NN 64-64-64-64 & 7k Epochen & 400^n Punkten",[20000,10000,[64,64]])
    
    
    approx_shepard = ShepardInterpolator([],1000)
    approx_identity = Approximator_Identity_ND([])
    apprx = [approx_nn_nd,approx_shepard]
    return apprx
